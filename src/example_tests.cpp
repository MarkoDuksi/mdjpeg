...
int main(int argc, char** argv) {
    ...
    std::cout << "Note: Single precision floating point math used by DownscalingBlockWriter\n"
              << "introduces sparse +/- 1 errors in values of some downscaled frame buffers.\n"
              << "Extent of these errors depends on frame buffer dimensions and content.\n"
              << "Effects of these errors are insignificant compared to errors introduced\n"
              << "beforehand by the lossiness of JPEG compression.\n\n";
